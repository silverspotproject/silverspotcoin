...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Silverspotcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dnsseed.silverspotcoin.com", "dnsseed.silverspotcoin.com"},
    {"dnsseed2.silverspotcoin.com", "dnsseed2.silverspotcoin.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"silverspotcointools.com", "testnet-seed.silverspotcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Silverspotcoin is probably already running."), addrBind.ToString().c_str());
        else
